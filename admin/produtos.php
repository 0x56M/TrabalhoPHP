        ...
        <div class="col-md-6 col-lg-5 px-0">
          <form action="cadastrar_produto.php" method="POST" enctype="multipart/form-data">
            <div>
              ...
              <input type="number" name="idCategoria" placeholder="Id da categoria" />
            </div>
            <div>
                <h4>Inserir produto</h4>
              <input type="text" name="produto_nome" placeholder="Nome do Produto" />
            </div>
            <div>
                <h4>Preço</h4>
            ...
            <div>
                ...
                <input type="file" id="produtoFile" name="produto_arquivo" style="display:none" onchange="mostrarProdutoSelecionado()" />
                <p id="produtoSelecionado">Nenhum produto selecionado</p>
            </div>
